...
<div class="card-body">
                    <form method="POST" action="{{ route('user.profile.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('division_id') is-invalid @enderror" name="division_id"required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('district_id') is-invalid @enderror" name="district_id" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="shipping_address" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" autocomplete="shipping_address" rows="3" autofocus>{{$user->shipping_address}}</textarea>
